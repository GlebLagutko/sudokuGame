...
export class SudokuGame {
    ...
    _get_candidates_map = function (board) {
    ...
    _get_square_vals_map = function (board) {
    ...
    _get_square_units_map = function (squares, units) {
    ...
    _get_square_peers_map = function (squares, units_map) {
    ...
    _get_all_units = function (rows, cols) {
    ...
    board_string_to_grid = function (board_string) {
    ...
    board_grid_to_string = function (board_grid) {
    ...
    _force_range = function (nr, max, min) {
